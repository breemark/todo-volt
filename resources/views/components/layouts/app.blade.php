...
<body class="min-h-screen font-sans antialiased overflow-y-scroll">
<x-main full-width>
    <x-slot:sidebar drawer="main-drawer" collapsible class="pt-3 bg-sky-800 text-white">

        {{-- Hidden when collapsed --}}
        <div class="hidden-when-collapsed ml-5 font-black text-4xl text-yellow-500">Todos</div>

        {{-- Display when collapsed --}}
        <div class="display-when-collapsed ml-5 font-black text-4xl text-orange-500">T</div>
        ...
        <x-menu activate-by-route active-bg-color="bg-base-300/10">
            ...
            <x-menu-item title="Nothing" icon="o-sparkles" link="####" />
